...
const Page: React.FC = () => {
  ...
  const contractAddress = "0x059125c6ffbb4ba6b8248aba569173483e916ec06c8234ba36ca02d954d69c42";
  ...
  return (
    <div className="h-screen flex flex-col justify-center items-center bg-white">
      ...
      <form onSubmit={handleSubmit} className="bg-black p-4 w-full max-w-md m-4 border-black border">
        <h3 className="text-2xl font-bold mb-2 black">Mint ERC20</h3>
        <label
          htmlFor="amount"
        ...
        <input
          ...
          className="block w-full px-3 py-2 text-sm leading-6 border-black focus:outline-none focus:border-yellow-300 black-border-p bg-black"
        />
